...
const Market = () => {
    ...
    const containerStyle = {justifyContent:"space-between",backgroundColor: 'white', margin: normalize(20),height:height-normalize(200)};
    ...
    return (
        ...
        <ScrollView 
            ...
            <Portal>
                ...
                <TouchableOpacity
                        onPress={()=>{hideModal()}}
                        style={{alignSelf:"flex-start",top:normalize(-8),left:normalize(-8)}}
                    >
                    <Icon
                        name={"close-circle"}
                        color={"black"}
                ...
                <Card
                    ...
                    <Card.Content>
                        ...
                        <Paragraph>Lorem Ipsdfmnsdfsd fsdfdskndfndfsdfsdbfn dnffsjf sf  jdsbfjs</Paragraph>
                    </Card.Content>
                </Card>
                <View
                    style={{
                        ...
                        renderItem={({item ,index}) => {
                            return(
                                <TouchableHighlight
                                    underlayColor='none'
                                    onPress={()=>{showModal()}}>
                                    <View style={[styles.pcontainer,{marginLeft:normalize(10)}]}>
